  ...
  const { error } = await supabase
    ...
    .update({
      ...
      trade_preferences: {
        ...
        sale_in_person: d.salePreferences.inPerson,
        sale_national_shipping: d.salePreferences.nationalShipping,
        sale_international_shipping: d.salePreferences.internationalShipping,
      },
