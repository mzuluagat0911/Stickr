...
export default function AuthLayout({
  ...
  return (
    <main className="relative flex min-h-[calc(100dvh-4rem)] flex-1 flex-col overflow-hidden">
      <AuthWc2026Backdrop />
      <div className="relative z-10 mx-auto flex w-full max-w-lg min-w-0 flex-1 flex-col justify-center px-4 py-10 pb-[max(2.5rem,env(safe-area-inset-bottom,0px))] md:px-6 md:py-14">
