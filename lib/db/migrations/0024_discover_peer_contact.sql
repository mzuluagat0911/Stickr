-- Contacto WhatsApp en Intercambio: número si visibility es always o post_trade (no never).
...
COMMENT ON FUNCTION public.get_discover_peers_contact (uuid[]) IS
  'WhatsApp E.164 de peers visibles en Intercambio (always o post_trade; nunca oculta el número).';
