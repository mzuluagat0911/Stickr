-- Parche: si 0012 falló tras CREATE TABLE public.market_deals (42P07), ejecuta este script completo.
-- Idempotente: seguro repetir.

CREATE INDEX IF NOT EXISTS market_deals_status_idx ON public.market_deals (status);
