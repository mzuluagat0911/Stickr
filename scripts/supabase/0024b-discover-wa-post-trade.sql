-- Actualiza Intercambio: muestra WhatsApp también con visibilidad «Tras intercambio» (post_trade).
-- Ejecutar si ya corriste 0024 pero no ves botones verdes. Luego recargá /discover.
