-- Parte 1/2 de migración 0023: función discover_collectors_exchange_ranked
-- Ejecutar en Supabase SQL Editor (Run). Luego ejecutar 0023-part2-overlap.sql
...
-- Obligatorio tras DROP + CREATE (si no, Intercambio falla con "permission denied").
