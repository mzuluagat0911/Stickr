...
export function AlbumGrid({
  ...
  return (
    <>
      {/* A todo el ancho del viewport: el color llega a los lados (fuera de max-w-6xl del layout). */}
      <div className="relative left-1/2 w-[100vw] max-w-[100vw] -translate-x-1/2 overflow-x-clip">
        <div className="relative w-full min-w-0">
          {/* overflow solo en la capa decorativa: no recorta paneles/flotantes del contenido (p. ej. repetidas en sm+). */}
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mt-1 max-w-2xl text-sm leading-relaxed">
                    ...
                    <span className="hidden md:inline">
                      Pulsa para avanzar el estado: falta → la tengo → repetida.
                    ...
                    <div className="-mx-1 flex max-w-full gap-2 overflow-x-auto px-1 pb-0.5 [-ms-overflow-style:none] [scrollbar-width:none] sm:flex-wrap sm:overflow-visible [&::-webkit-scrollbar]:hidden">
                      {(
                        ...
                        <Button
                          ...
                          size="sm"
                          variant={
                            statusFilter === value ? "secondary" : "outline"
                          }
                  ...
                  {emptySearchHint ? null : introFwc.length === 0 ? (
                    ...
                    <div className="space-y-3">
                      <p className="text-muted-foreground text-sm leading-relaxed">
                        Bloque inicial Panini (FWC): escudo, trofeo, mascota,
                        balón, sedes anfitrionas y resto del tramo intro según
                        catálogo digital.
                      </p>
                      <div className="grid grid-cols-4 gap-1.5 min-[420px]:grid-cols-5 sm:gap-2">
                    ...
                    {emptySearchHint ? null : g.teams.every(
                      ...
                      <>
                        <p className="text-muted-foreground text-sm leading-relaxed">
                          ...
                          {g.teams
                            .map(
                              (t) => `${fifaTeamFlagEmoji(t.code)} ${t.name}`,
                            )
                            .join(" · ")}
                        </p>
                ...
                <TabsContent value="museum">
                  {emptySearchHint ? null : museum.length === 0 ? (
                    <div className="text-muted-foreground space-y-2 py-8 text-center text-sm leading-relaxed">
                      <p>
                        Este catálogo aún no incluye el bloque Museo (10
                        figuritas).
                      </p>
                      <p>
                        Ejecutá{" "}
                    ...
                    <div className="space-y-3">
                      <p className="text-muted-foreground text-sm leading-relaxed">
                        En el álbum Panini, los campeones históricos van al
                        final como FWC9– FWC19 (11 figuritas). Aquí usamos el
                        bloque MUSEUM del catálogo digital (n.º{" "}
