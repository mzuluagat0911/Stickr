...
export function AlbumGrid({
  ...
  return (
    <>
      <div className="relative w-full min-w-0 overflow-hidden rounded-[1.75rem] sm:rounded-[2rem]">
        <AuthWc2026Backdrop />
        <div className="relative z-10 w-full px-2 pt-2 pb-2 sm:px-3 sm:pt-3 sm:pb-3">
          <div className="w-full max-w-full space-y-6 rounded-[1.5rem] bg-white px-4 py-6 text-zinc-900 shadow-[0_25px_60px_-12px_rgb(0_0_0_/_0.35)] ring-1 ring-black/10 min-[400px]:px-5 sm:rounded-[2rem] sm:px-8 sm:py-8 dark:bg-zinc-950 dark:text-zinc-50 dark:ring-white/10">
            ...
            <div className="sticky top-0 z-30 space-y-3 rounded-xl border border-zinc-200/80 bg-white/90 p-4 shadow-sm backdrop-blur-md supports-backdrop-filter:bg-white/85 dark:border-zinc-700/80 dark:bg-zinc-950/90 dark:supports-backdrop-filter:bg-zinc-950/85">
